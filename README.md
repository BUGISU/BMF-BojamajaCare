...
| 구분             | 내용                                                                                                                                                                                            |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **개발 기간 / 역할** | **2022.03 \~ 2022.10 (총 8개월)**<br>팀 프로젝트 (개발인원 4명)<br>**UI/흐름 설계, 얼굴 인식 모듈, 터치 & 손 인식 게임, Kinect 전신 운동, 운동 기록 시스템 개발**                                                                        |
| **플랫폼**        | Windows 기반 전용 키오스크                                                                                                                                                                            |
| **주요 기여**      | - **UI/흐름 설계 및 회원가입·얼굴 인식 로그인 모듈 개발 (3\~5월)**<br>- **터치 게임(숫자판/퍼즐) 및 손 인식 게임(깃발, 손가락 체조) 구현 (6\~7월)**<br>- **Kinect 기반 전신 운동 콘텐츠 및 판정 로직 개발 (8\~9월)**<br>- **운동 레포트·DB 연동, QA 및 전시 배포 (10월)** |
